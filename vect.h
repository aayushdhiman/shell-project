...
/** Creates a smaller vector with the values from the start to end point of the given vector */
vect_t* vect_substring(vect_t *v, int start, int stop);

/** Gets the index of the specified value in the vector */
